...
The `vercel.json` configures a weekly cron job to ping `/api/keepalive`. This performs a lightweight query on your Supabase DB to prevent it being paused on the free tier.
